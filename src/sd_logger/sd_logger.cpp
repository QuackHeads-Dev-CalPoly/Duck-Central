...
uint8_t sd_logger::init_sd_card()
{
    ...
    printf("Final init: CMD55 and ACMD41\n");
...
{
    record new_record;
    memset((uint8_t*)&new_record, 0x00, 512);
    
    new_record.timestamp = millis();    
