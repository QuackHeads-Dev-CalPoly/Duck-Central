...
#define WIFI_FIMRWARE_REQUIRED WIFI_FIMRWARE_LATEST_MODEL_B
...
public:
    ...
    /* Temporarily leaving out as I don't want these to change 
   ...
   /* Start Wifi connection with WPA/WPA2 encryption.
    ...
    /* Temporarily leaving out as I don't want to use string variants
    ...
    */
    ...
    /* TODO: Add IPAddress code as modified last night */
    ...
    /* Temporarily leave out. Don't want to use string variant
